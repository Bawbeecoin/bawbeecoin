...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 BAW
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 BAW mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 2100000 * COIN; //84000000 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
    	...
    	return dPriority > COIN * 720 / 250; // 60 / 2 * 24 - blocks per day
    }
