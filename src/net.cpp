...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bawbeecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bawbeecointools.com", "dnsseed.bawbeecointools.com"},
    {"bawbeecoinpool.org", "dnsseed.bawbeecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"bawbeecointools.com", "testnet-seed.bawbeecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bawbeecoin is probably already running."), addrBind.ToString().c_str());
        else
